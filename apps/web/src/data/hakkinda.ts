/**
 * Hakkında sayfasının içeriği burada.
 * Her paragraf ayrı bir string — dilediğiniz gibi düzenleyin.
 */

export const hakkindaMetni = {
  /** Sayfanın üstünde italik olarak görünen açılış cümlesi */
  acisCumlesi:
    "Kaspar Hauser kimdir? Nereden geldiğini bilmiyordu. Adından başkasını bilmiyordu. Ve bu belirsizlik onu sonsuz kıldı.",

  /** Ana paragraflar — sırasıyla sayfada yer alır */
  paragraflar: [
...
Öncesinde, yayınevinin çıkardığı Underground Poetixi dergisiyle
edebiyat dünyasına adım atıldı.`,
...
odaklı bir yayın anlayışı benimsenir.`,
  ...
  /** Yan panel bilgileri */
  bilgiler: {
    yayinevi: "6:45 yayınları",
    kurulus: "2024",
    dil: "Türkçe",
    format: "Dijital · Periyodik",
  },

  /** Önceki yayınlar bölümü */
  oncekiYayinlar: [
    {
      yillar: "2022 — 2024",
      isim: "Underground Poetixi",
      aciklama: `6:45 yayınlarının ilk dergisi. Yeraltı edebiyatının kenarlarında
